...
struct ChrManipulator_ActionInputtedTimeHeld
{
    ...
    float time_beckon_emote_held;
    float time_point_forward_emote_held;
    float time_hurrah_emote_held;
    float time_bow_emote_held;
    float time_joy_emote_held;
    float time_shrug_emote_held;
    float time_wave_emote_held;
    float time_praise_the_sun_emote_held;
    float time_point_up_emote_held;
    float time_point_down_emote_input;
    float time_look_skyward_emote_held;
    float time_well_what_is_it_emote_held;
    float time_prostration_emote_held;
    float time_proper_bow_emote_held;
    float time_prayer_emote_held;
    float field37_0x94;
    float field38_0x98;
    float field39_0x9c;
    float field40_0xa0;
...
struct ChrManipulator_ActionInputted
{
    ...
    bool parry_input;
    bool block_input;
    bool beckon_emote_input;
    bool point_forward_emote_input;
    bool hurrah_emote_input;
    bool bow_emote_input;
    bool joy_emote_input;
    bool shrug_emote_input;
    bool wave_emote_input;
    bool praise_the_sun_emote_input;
    bool point_up_emote_input;
    bool point_down_emote_input;
    bool look_skyward_emote_input;
    bool well_what_is_it_emote_input; // become giant
    bool prostration_emote_input;
    bool proper_bow_emote_input;
    bool prayer_emote_input;
    bool field37_0x25;
    bool field38_0x26;
    bool field39_0x27;
    bool field40_0x28;
